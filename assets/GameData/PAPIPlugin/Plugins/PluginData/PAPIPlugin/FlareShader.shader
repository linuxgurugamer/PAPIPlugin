...
#line 424
#line 382
lowp vec4 LightingNoLighting( in SurfaceOutput s, in lowp vec3 lightDir, in lowp float atten ) {
    #line 384
    lowp vec4 c;
    c.xyz = s.Albedo;
    c.w = s.Alpha;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    c = LightingNoLighting( o, _WorldSpaceLightPos0.xyz, atten);
...
Program "fp" {
// Fragment combos: 2
//   opengl - ALU: 4 to 7, TEX: 1 to 2
//   d3d9 - ALU: 4 to 6, TEX: 1 to 2
//   d3d11 - ALU: 2 to 5, TEX: 1 to 2, FLOW: 1 to 1
//   d3d11_9x - ALU: 2 to 5, TEX: 1 to 2, FLOW: 1 to 1
SubProgram "opengl " {
Keywords { "DIRECTIONAL" "LIGHTMAP_OFF" "DIRLIGHTMAP_OFF" }
Vector 0 [_Color]
Float 1 [_Alpha]
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecednfmciamkkdjllkokedjfmnkcbhkdceidabaaaaaanmabaaaaadaaaaaa
...
gbhcghgfheaaklklfdeieefcomaaaaaaeaaaaaaadlaaaaaafjaaaaaeegiocaaa
...
abaaaaaaeghobaaaaaaaaaaaaagabaaaaaaaaaaaaaaaaaaihcaabaaaaaaaaaaa
egacbaaaaaaaaaaaegiccaaaaaaaaaaaadaaaaaadiaaaaaiiccabaaaaaaaaaaa
dkaabaaaaaaaaaaaakiacaaaaaaaaaaaaeaaaaaadcaaaaajhccabaaaaaaaaaaa
egacbaaaaaaaaaaaegbcbaaaadaaaaaaegacbaaaaaaaaaaadoaaaaab"
}
...
adaaaaaaabaaahacaaaaaakeacaaaaaaacaaaaoeaeaaaaaa mul r1.xyz, r0.xyzz, v2
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedpnohigeffmmkpjoogalecipkdfeniahbabaaaaaajiacaaaaaeaaaaaa
daaaaaaaoiaaaaaanmabaaaageacaaaaebgpgodjlaaaaaaalaaaaaaaaaacpppp
...

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedheijnkeicnenghhbddlfohimljjhogbmabaaaaaadeacaaaaadaaaaaa
...
dkaabaaaabaaaaaaakiacaaaaaaaaaaaaeaaaaaadiaaaaahhccabaaaaaaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecednoadlmddflmkeloobljfahfjlecmgacoabaaaaaaeeadaaaaaeaaaaaa
...

...
aaaaaaaihcaabaaaabaaaaaaegacbaaaabaaaaaaegiccaaaaaaaaaaaadaaaaaa
diaaaaaiiccabaaaaaaaaaaadkaabaaaabaaaaaaakiacaaaaaaaaaaaaeaaaaaa
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    lowp vec4 c = LightingNoLighting( o, lightDir, (texture( _LightTexture0, vec2( dot( IN._LightCoord, IN._LightCoord))).w * 1.0));
    c.w = o.Alpha;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    lowp vec4 c = LightingNoLighting( o, lightDir, 1.0);
    c.w = o.Alpha;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 448
    lowp vec3 lightDir = normalize(IN.lightDir);
    lowp vec4 c = LightingNoLighting( o, lightDir, (((float((IN._LightCoord.z > 0.0)) * UnitySpotCookie( IN._LightCoord)) * UnitySpotAttenuate( IN._LightCoord.xyz)) * 1.0));
    c.w = o.Alpha;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 440
    lowp vec3 lightDir = normalize(IN.lightDir);
    lowp vec4 c = LightingNoLighting( o, lightDir, ((texture( _LightTextureB0, vec2( dot( IN._LightCoord, IN._LightCoord))).w * texture( _LightTexture0, IN._LightCoord).w) * 1.0));
    c.w = o.Alpha;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
lowp vec4 frag_surf( in v2f_surf IN ) {
    ...
    #line 439
    lowp vec3 lightDir = IN.lightDir;
    lowp vec4 c = LightingNoLighting( o, lightDir, (texture( _LightTexture0, IN._LightCoord).w * 1.0));
    c.w = o.Alpha;
    return c;
}
in highp vec2 xlv_TEXCOORD0;
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefieceddmipmdfeglehmklcbblchfeolojkfeahabaaaaaameabaaaaadaaaaaa
...

doaaaaab"
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...
aagabaaaaaaaaaaaaaaaaaaihccabaaaaaaaaaaaegacbaaaaaaaaaaaegiccaaa
aaaaaaaaahaaaaaadiaaaaaiiccabaaaaaaaaaaadkaabaaaaaaaaaaaakiacaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
abaaaaaaefaaaaajpcaabaaaaaaaaaaaegbabaaaabaaaaaaeghobaaaaaaaaaaa
aagabaaaaaaaaaaaaaaaaaaihccabaaaaaaaaaaaegacbaaaaaaaaaaaegiccaaa
aaaaaaaaadaaaaaadiaaaaaiiccabaaaaaaaaaaadkaabaaaaaaaaaaaakiacaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...
// FLOW 1 static, 0 dynamic
"ps_4_0

...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedlegehhnajfojjeoidinfcencjaeaoceiabaaaaaameabaaaaadaaaaaa
cmaaaaaammaaaaaaaaabaaaaejfdeheojiaaaaaaafaaaaaaaiaaaaaaiaaaaaaa
aaaaaaaaabaaaaaaadaaaaaaaaaaaaaaapaaaaaaimaaaaaaaaaaaaaaaaaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1

